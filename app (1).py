...
<div class="main-header">
    ...
    <p>Tác giả: Lưu Văn Phong - Trường TH Vĩnh Thành - ĐT: 0386276759</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Lưu Văn Phong - Trường TH Vĩnh Thành - ĐT: 0386276759</div>", unsafe_allow_html=True)
